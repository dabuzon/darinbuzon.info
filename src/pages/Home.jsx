  ...
  render() {
    return (
      <Container pt="55px" pb="55px">
        <Header />
        <Entry name="Guggenheim" info="Development and implementation of a comprehensive style guide to address the museum's need for a more accessible web interface for visitors." ppl="In collaboration with and special thanks to Ben Kasum as well as the rest of the Use All Five family."/>
        ...
        <Entry name="Posters" info="Commissions, assignments, and self-initiated undertakings within the medium of posters. Clients included UCLA Herb Alpert School of Music, Use All Five, and UCLA Design | Media Arts." ppl="In collaboration with and special thanks to Willem Henri Lucas, Troy Kreiner, and most importantly Israel Gutierrez."/>
