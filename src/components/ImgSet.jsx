const gimg0 = require("./img/01_guggenheim/GUGG_2.jpg");
const gimg1 = require("./img/01_guggenheim/GUGG_3.jpg");
...
const aimg2 = require("./img/03_accepting/SOD_3.jpg");
const aimg3 = require("./img/03_accepting/SOD_4.jpg");
...
export const GuggImg = [gimg0, gimg1, gimg2, gimg3];
export const FluxImg = [uimg0, uimg1, uimg2, uimg3, uimg4, uimg5];
